    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            conversation_history = [
                ...
                I-Venture at ISB or DLabs ISB from web search and you need to engage in a helpful, detailed, conversation with a user. Also list sources of answer"}  + st.session_state.messages]
