    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            conversation_history = [
                {"role": "system", "content": "You are an artificial intelligence assistant which answers questions related to I-Venture at ISB or DLabs ISB from web search and you need to engage in a helpful, detailed, conversation with a user. Also list sources of answer"}  + st.session_state.messages]
